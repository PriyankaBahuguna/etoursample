                        ...
                        <div>
                            <div className="row">
                                <div className="col-md-6" >
                                    <div  >
                                    <p class="bottom-logo-title" style={{ color: "white" }}>Select your activities </p>
                                        <form onSubmit={(e) => { e.preventDefault(); setMyData(["Cultural Exploration"]) }} >
                                            <span >
                                                <input className="mt-3 px-3 bg-warning rounded-pill text-center" value="Cultural Exploration" onChange={(e) => setMyData(e.target.value)} />
                                    ...
                                    <div>
                                        <form onSubmit={(e) => { e.preventDefault(); setMyData2(["Local market visit"]) }} >
                                            <span >
                                                <input className="my-1 px-3 bg-warning rounded-pill" value="Local market visit" onChange={(e) => setMyData2(e.target.value)} />
                                    ...
                                    <div>
                                        <form onSubmit={(e) => { e.preventDefault(); setMyData3(["Mandovi River  cruise"]) }} >
                                            <span >
                                                <input className="my-1 px-3 bg-warning rounded-pill" value="Mandovi River  cruise" onChange={(e) => setMyData3(e.target.value)} />
                                    ...
                                    <div>
                                        <form onSubmit={(e) => { e.preventDefault(); setMyData4(["Water sports at Grand island"]) }} >
                                            <span >
                                                <input className="my-1 px-3 bg-warning rounded-pill" value="Water sports at Grand island " onChange={(e) => setMyData4(e.target.value)} />
                                    ...
                                    <div>
                                        <form onSubmit={(e) => { e.preventDefault(); setMyData5(["Clubbing at Tito's lane   "]) }} >
                                            <span >
                                                <input className="my-1 px-3 bg-warning rounded-pill" value="Clubbing at Tito's lane" onChange={(e) => setMyData5(e.target.value)} />
                                    ...
                                    <div>
                                        <form onSubmit={(e) => { e.preventDefault(); setMyData6(["A day at Baga Beach    "]) }} >
                                            <span >
                                                <input className="my-1 px-3 bg-warning rounded-pill" value="A day at Baga Beach" onChange={(e) => setMyData6(e.target.value)} />
                                ...
                                <div className="col-md-6">
                                        ...
                                        <div >
                                            <div>
                                            <p class="bottom-logo-title" style={{ color: "white" }}>Your  selected activities </p>
                                          
                                                {myData.map((each, idx) => (
                                                    <div key={idx} >
                                                   
                                                    <div className=" d-flex justify-content-center">
                                                        <p className="bg-warning rounded-pill px-3">{each}</p>
                                                        <span onClick={() => onDelete(idx)} ><p className=" border-black px-2 rounded bg-danger">remove</p></span>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                            <div>
                                                {myData2.map((each, idx) => (
                                                    <div key={idx} className=" d-flex justify-content-center">
                                                        <p className="bg-warning rounded-pill px-3">{each}</p>
                                                        <span  onClick={() => onDelete2(idx)}><p className=" border-black px-2 rounded bg-danger">remove</p></span>
                                                    </div>
                                                ))}
                                            </div>
                                            <div>
                                                {myData3.map((each, idx) => (
                                                    <div key={idx} className=" d-flex justify-content-center">
                                                        <p className="px-3 bg-warning rounded-pill">{each}</p>
                                                        <span  onClick={() => onDelete3(idx)}><p className=" border-black px-2 rounded bg-danger">remove</p></span>
                                                    </div>
                                                ))}
                                            </div>
                                            <div>
                                                {myData4.map((each, idx) => (
                                                    <div key={idx} className=" d-flex justify-content-center">
                                                        <p className="bg-warning rounded-pill px-3">{each}</p>
                                                        <span onClick={() => onDelete4(idx)}><p className=" border-black px-2 rounded bg-danger">remove</p></span>
                                                    </div>
                                                ))}
                                            </div>
                                            <div>
                                                {myData5.map((each, idx) => (
                                                    <div key={idx} className=" d-flex justify-content-center">
                                                        <p className="bg-warning rounded-pill px-3">{each}</p>
                                                        <span onClick={() => onDelete5(idx)}><p className=" border-black px-2 rounded bg-danger">remove</p></span>
                                                    </div>
                                                ))}
                                            </div>
                                            <div>
                                                {myData6.map((each, idx) => (
                                                    <div key={idx} className=" d-flex justify-content-center">
                                                        <p className="bg-warning rounded-pill px-3">{each}</p>
                                                        <span  onClick={() => onDelete6(idx)}><p className=" border-black px-2 rounded bg-danger">remove</p></span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
